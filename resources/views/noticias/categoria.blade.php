...
<head>
    ...
    <title>Noticias de {{ $categoria->nombre }}</title>
    ...
    <main class="max-w-7xl mx-auto py-10 px-6">
        ...
        @else
            <div class="text-center py-12">
                ...
                <h3 class="text-xl font-semibold text-gray-700 mb-2">No hay noticias en esta categoría</h3>
                <p class="text-gray-500">Pronto habrá contenido disponible.</p>
            </div>
        @endif
    </main>
